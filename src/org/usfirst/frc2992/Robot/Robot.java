...
import org.usfirst.frc2992.Robot.Autonomous.*;
...
public class Robot extends IterativeRobot {
 ...
 // Vision constants
    public static final boolean SimpleVision = Constants.SimpleVision;
    CameraServer server;
    public static final String frontCamName = Constants.frontCamName;
    public static final int imgQual = Constants.imgQual;
    // Constants for 2 camera vision mode (only used if SimpleVision is false)
    public static final int btFrontCam = Constants.btFrontCam;
    public static final int btRearCam = Constants.btRearCam;
    public static final String rearCamName = Constants.rearCamName;
