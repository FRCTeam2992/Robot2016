...
public class RobotMap {
    ...
    public static int[] leftMotors = {0, 1, 2};
    public static int[] rightMotors = {3, 4, 5};
    ...
    public static void init() {
        ...
        mhRobotDrive = new org.usfirst.frc2992.Robot.subsystems.mhRobotDrive(leftMotors, rightMotors);
    }
}
