...
import org.usfirst.frc2992.Robot.commands.ArmIn;
 ...
 *
 */
public class AutoISurrender extends CommandGroup {
    ...
    public AutoISurrender() {
        ...
        // arm.
    	addParallel(new DriveAuto(88.0, 0.0, 5.0));
    	addSequential(new WaitCommand(5.0));
    	addParallel(new DriveAuto(-2.5, 0.0, 0.5));
    	addParallel(new ArmOut());
    	addSequential(new WaitCommand(0.5));
    	addParallel(new DriveAuto(84.0, 0.0, 5.0));
    	addSequential(new WaitCommand(5.0));
